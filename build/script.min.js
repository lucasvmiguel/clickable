...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.default = {\n    api: {\n        url: \"https://whatever.com\"\n    },\n    script: {\n        keyParam: \"key\"\n    },\n    htmlIdentifiers: {\n        script: \"clickable-js\",\n        menu: \"clickable-menu\",\n        menuOptions: \"clickable-menu-options\",\n        menuOption: \"clickable-menu-option\"\n    },\n    htmlAttrs: {\n        value: \"data-clickable-value\",\n        menu: \"data-clickable-menu\"\n    },\n    breakpoints: {\n        mobile: 600,\n        desktop: 900\n    }\n};\n\n\n//# sourceURL=webpack:///./build/config.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar config_1 = __webpack_require__(/*! ./config */ \"./build/config.js\");\nvar menu = __webpack_require__(/*! ./menu */ \"./build/menu.js\");\nvar api = __webpack_require__(/*! ./api */ \"./build/api.js\");\nvar qs = __webpack_require__(/*! ./query-params */ \"./build/query-params.js\");\nvar screen = __webpack_require__(/*! ./screen */ \"./build/screen.js\");\nvar apiConfig;\nvar tag = screen.getElementById(config_1.default.htmlIdentifiers.script);\nvar qsParams = qs.getQueryParamsFromUrl(tag.src);\napi.getConfig(qsParams[config_1.default.script.keyParam]).then(function (response) { return apiConfig = response; });\nscreen.addMouseEvent(\"click\", function (event) {\n    if (!menu.isMenuVisible()) {\n        return;\n    }\n    console.log(event.target);\n    console.log(menu.getMenuValue());\n    menu.deleteMenuNode();\n});\nscreen.addMouseEvent(\"contextmenu\", function (event) {\n    var attrs = menu.getFirstClickableAttribute(event.target);\n    menu.deleteMenuNode();\n    if (!menu.shouldShowMenu(apiConfig, attrs)) {\n        return;\n    }\n    event.preventDefault();\n    menu.createMenu(apiConfig, event, attrs);\n    return false;\n});\n\n\n//# sourceURL=webpack:///./build/index.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar config_1 = __webpack_require__(/*! ./config */ \"./build/config.js\");\nvar icon = __webpack_require__(/*! ./icon */ \"./build/icon.js\");\nvar mouse = __webpack_require__(/*! ./mouse */ \"./build/mouse.js\");\nvar screen = __webpack_require__(/*! ./screen */ \"./build/screen.js\");\nvar menuValue = null;\nvar menuVisible = false;\nexports.isMenuVisible = function () {\n    return menuVisible;\n};\nexports.getMenuValue = function () {\n    return menuValue;\n};\nexports.shouldShowMenu = function (apiConfig, attrs) {\n    if (!apiConfig.global && !attrs) {\n        return false;\n    }\n    var screenWidth = screen.getWidth();\n    if (!apiConfig.breakpoints.mobile && screenWidth < config_1.default.breakpoints.mobile) {\n        return false;\n    }\n    if (!apiConfig.breakpoints.tablet && screenWidth >= config_1.default.breakpoints.mobile && screenWidth < config_1.default.breakpoints.desktop) {\n        return false;\n    }\n    if (!apiConfig.breakpoints.desktop && screenWidth >= config_1.default.breakpoints.desktop) {\n        return false;\n    }\n    return true;\n};\nexports.createMenu = function (apiConfig, event, attrs) {\n    var position = mouse.getPositionClicked(event);\n    var items = attrs && attrs.menu && apiConfig.menu[attrs.menu] ? apiConfig.menu[attrs.menu] : apiConfig.menu.default;\n    var markup = menuMarkup(items);\n    screen.getElementByTag(\"body\").innerHTML += markup;\n    var menuNode = screen.getElementById(config_1.default.htmlIdentifiers.menu);\n    setPosition(menuNode, position);\n    menuValue = attrs && attrs.value;\n    menuVisible = true;\n};\nexports.deleteMenuNode = function () {\n    var menu = screen.getElementById(config_1.default.htmlIdentifiers.menu);\n    if (!menu) {\n        return;\n    }\n    menu.parentElement.removeChild(menu);\n    menuVisible = false;\n    menuValue = null;\n};\nexports.getFirstClickableAttribute = function (node) {\n    if (!node || !node.getAttributeNode) {\n        return null;\n    }\n    var valueAttr = node.getAttribute(config_1.default.htmlAttrs.value);\n    var menuAttr = node.getAttribute(config_1.default.htmlAttrs.menu);\n    if (valueAttr || menuAttr) {\n        return { value: valueAttr, menu: menuAttr };\n    }\n    // @ts-ignore\n    return exports.getFirstClickableAttribute(node.parentNode);\n};\nvar setPosition = function (menuNode, position) {\n    var screenWidth = screen.getWidth();\n    var screenHeight = screen.getHeight();\n    var fixedLeft = position.left + menuNode.offsetWidth <= screenWidth ? position.left : position.left - menuNode.offsetWidth;\n    var fixedTop = position.top + menuNode.offsetHeight <= screenHeight ? position.top : position.top - menuNode.offsetHeight;\n    menuNode.style.left = fixedLeft + \"px\";\n    menuNode.style.top = fixedTop + \"px\";\n};\nvar menuMarkup = function (options) {\n    if (options.length < 1) {\n        return '';\n    }\n    var optionsMarkup = options.map(function (o) { return itemMarkup(o); }).join('');\n    return \"\\n    <div id=\\\"\" + config_1.default.htmlIdentifiers.menu + \"\\\" style=\\\"display: block\\\">\\n      <ul class=\\\"\" + config_1.default.htmlIdentifiers.menuOptions + \"\\\">\\n        \" + optionsMarkup + \"\\n      </ul>\\n    </div>\\n  \";\n};\nvar itemMarkup = function (option) { return \"\\n  <li class=\\\"\" + config_1.default.htmlIdentifiers.menuOption + \"\\\" id=\\\"\" + config_1.default.htmlIdentifiers.menuOption + \"-\" + option.id + \"\\\">\\n    \" + icon.getIconMarkup(option.icon) + \"\\n    \" + option.text + \"\\n  </li>\\n\"; };\n\n\n//# sourceURL=webpack:///./build/menu.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.getPositionClicked = function (event) { return ({\n    left: event.pageX,\n    top: event.pageY\n}); };\n\n\n//# sourceURL=webpack:///./build/mouse.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.getQueryParamsFromUrl = function (url) {\n    var query = url.replace(/^[^\\?]+\\??/, '');\n    var vars = query.split(\"&\");\n    var args = {};\n    for (var i = 0; i < vars.length; i++) {\n        var pair = vars[i].split(\"=\");\n        args[pair[0]] = decodeURI(pair[1]).replace(/\\+/g, ' ');\n    }\n    return args;\n};\n\n\n//# sourceURL=webpack:///./build/query-params.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.addMouseEvent = function (name, callback) {\n    window.addEventListener(name, callback);\n};\nexports.getElementByTag = function (tag) {\n    var tagHtml = window.document.getElementsByTagName(tag);\n    if (tagHtml) {\n        return tagHtml[0];\n    }\n    return undefined;\n};\nexports.getElementById = function (id) {\n    return window.document.getElementById(id);\n};\nexports.getWidth = function () {\n    return window.innerWidth;\n};\nexports.getHeight = function () {\n    return window.innerHeight;\n};\n\n\n//# sourceURL=webpack:///./build/screen.js?");

/***/ }),

/***/ 0:
/*!**********************************************************************************************************************************************************!*\
  !*** multi ./build/api.js ./build/config.js ./build/icon.js ./build/index.js ./build/menu.js ./build/mouse.js ./build/query-params.js ./build/screen.js ***!
  \**********************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! ./build/api.js */\"./build/api.js\");\n__webpack_require__(/*! ./build/config.js */\"./build/config.js\");\n__webpack_require__(/*! ./build/icon.js */\"./build/icon.js\");\n__webpack_require__(/*! ./build/index.js */\"./build/index.js\");\n__webpack_require__(/*! ./build/menu.js */\"./build/menu.js\");\n__webpack_require__(/*! ./build/mouse.js */\"./build/mouse.js\");\n__webpack_require__(/*! ./build/query-params.js */\"./build/query-params.js\");\nmodule.exports = __webpack_require__(/*! ./build/screen.js */\"./build/screen.js\");\n\n\n//# sourceURL=webpack:///multi_./build/api.js_./build/config.js_./build/icon.js_./build/index.js_./build/menu.js_./build/mouse.js_./build/query-params.js_./build/screen.js?");
